...
SERVICE_CAPS = jjacobson95MetaPathPredict_KBase
SPEC_FILE = jjacobson95MetaPathPredict_KBase.spec
URL = https://kbase.us/services/jjacobson95metapathpredict_kbase
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
